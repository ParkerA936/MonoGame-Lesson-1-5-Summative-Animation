...
namespace MonoGame_Lesson_1_5_Summative_Animation
{
    ...
    public class Game1 : Game
    {
        ...
        Texture2D starBackTexture, explosionBackTexture;
        SpriteFont skyText;
        Rectangle window,starBackRect, explosionBackRect;
        Screen screen;
        ...
        protected override void LoadContent()
        {
            ...
            explosionBackTexture = Content.Load<Texture2D>("death-star");
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            {
                _spriteBatch.Draw(explosionBackTexture, explosionBackRect, Color.White);
